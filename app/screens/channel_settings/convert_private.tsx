...
const messages = defineMessages({
    convertPrivateTitle: {
        ...
        defaultMessage: 'Convert {displayName} to a private course?',
    },
    convertPrivateDescription: {
        id: 'channel_info.convert_private_description',
        defaultMessage: 'When you convert {displayName} to a private course, history and membership are preserved. Publicly shared files remain accessible to anyone with the link. Membership in a private course is by invitation only.\n\nThe change is permanent and cannot be undone.\n\nAre you sure you want to convert {displayName} to a private course?',
    },
    alertNo: {
    ...
    convertFailed: {
        ...
        defaultMessage: 'We were unable to convert {displayName} to a private course.',
    },
    convertPrivateSuccess: {
        id: 'channel_info.convert_private_success',
        defaultMessage: '{displayName} is now a private course.',
    },
    errorClose: {
...
const ConvertPrivate = ({canConvert, channelId, displayName}: Props) => {
    ...
    return (
        <OptionItem
            ...
            label={intl.formatMessage({id: 'channel_info.convert_private', defaultMessage: 'Convert to private course'})}
            icon='lock-outline'
            type='default'
