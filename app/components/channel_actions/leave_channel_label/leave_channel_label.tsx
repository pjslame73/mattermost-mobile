...
const messages = defineMessages({
    ...
    leaveChannel: {
        ...
        defaultMessage: 'Leave course',
    },
    leavePrivateChannel: {
        id: 'channel_info.leave_private_channel',
        defaultMessage: "Are you sure you want to leave the private course {displayName}? You cannot rejoin the course unless you're invited again.",
    },
    leavePublicChannel: {
        id: 'channel_info.leave_public_channel',
        defaultMessage: 'Are you sure you want to leave the public course {displayName}? You can always rejoin.',
    },
    cancel: {
